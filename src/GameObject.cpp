...
void GameObject::incBet() {
	playerBet++;

}

void GameObject::decBet() {
	playerBet++;
...
void GameObject::incCredit() {
	playerCredit++;

}

void GameObject::decCredit() {
	playerCredit++;

}

int GameObject::getCredit() {
	return playerCredit;
...
int GameObject::getR3() {
	return r3;
}

void GameObject::wonCreds(int multi) {
	creditsWon = playerBet * multi;
}

int GameObject::getWonCreds() {
	return creditsWon;
}
